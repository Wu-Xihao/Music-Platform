...
+ 人员分配：杨周、杨可、石闰同
+ 根据方案书大纲，先自行分配章节撰写，系统设计可参考以下CSDN的内容
+ [网易音乐网站系统|前后端分离springboot+vue实现在线音乐网站_基于spring boot和vue框架的音乐分享平台-CSDN博客](https://blog.csdn.net/znzbs/article/details/129834170)
...
+ 用户端首页、歌单歌手管理界面优化（何）
+ 管理端ECharts表格界面优化（吴）
+ 音乐播放界面优化（可以尝试添加新功能，如音乐波形图、粒子图等）（何）
+ 系统功能测试与其他bug修复（吴）